...
ROOT_DIR = environ.Path(__file__) - 3  # (sangseokgram/config/settings/base.py - 3 = sangseokgram/)
APPS_DIR = ROOT_DIR.path('sangseokgram')
...
MIGRATION_MODULES = {
    'sites': 'sangseokgram.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Sangseok Doe""", 'sangseoksoftware@outlook.com'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'sangseokgram.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'sangseokgram.users.adapters.SocialAccountAdapter'
